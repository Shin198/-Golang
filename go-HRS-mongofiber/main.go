...
type Employee struct {
	EID     string  `json:"eid,omitempty" bson:"_id,omitempty"`
...
func main() {
	...
	app.Delete("/employee/:id", func(c *fiber.Ctx) error {
		...
		emploeeId, err := primitive.ObjectIDFromHex(c.Params("id"))
		if err != nil {
			return c.SendStatus(400)
		}
		query := bson.D{{Key: "_id", Value: emploeeId}}
